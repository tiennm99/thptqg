...
//
// The article is a school site that aggregated every cluster's file.
//
...
//   - parser/testdata/reader-fidelity-hashes.tsv is keyed by full path and is
//     frozen, so a renamed file no longer matches its oracle entry.
//
